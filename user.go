...
//secret key
//TODO: create a separate file to store the secret key
...
func handlerLogin(w http.ResponseWriter, r *http.Request) {
	...
	//Error in connecting to the server--error 500
	...
	//Use jwt lib to create the token
	//need to provide payload and encryption method
	token := jwt.NewWithClaims(jwt.SigningMethodHS256, jwt.MapClaims{
		"username": user.Username,
		"exp":      time.Now().Add(time.Hour * 24).Unix(),
	})

	//sign and get token to the user
...
func handlerSignup(w http.ResponseWriter, r *http.Request) {
	...
	//check username and password regulation
